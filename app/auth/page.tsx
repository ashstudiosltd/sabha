  ...
  return (
    <main className="relative h-screen w-screen overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 flex h-full">
        {/* Sidebar */}
        <div className="relative flex w-full max-w-md flex-col justify-between p-8">
          ...
          <div className="relative z-10">
            ...
            <p className="mb-8 text-sm text-gray-300">
             We know how hard it is to be a developer. It doesn't have to be. Join Devvrats and explore the community, blogs, projects and more.
            </p>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                disabled={loading}
                className="flex w-full items-center justify-center gap-2 rounded-md bg-white py-2 text-black transition hover:bg-gray-200 disabled:opacity-50"
              >
                <svg
