    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          {/* Site Map */}
          <div>
            <p className="text-[11px] font-medium tracking-[2px] text-white uppercase mb-4">
              Site Map
            </p>
            ...
            <ul className="flex flex-col gap-2.5">
              {siteLinks.map((l) => (
                <li key={l.label}>
                  <Link
                    href={l.href}
                    className="text-[13px] text-white hover:text-white/70 transition-colors duration-150 no-underline block"
                  >
            ...
            <ul className="flex flex-col gap-2.5">
              {communityLinks.map((l) => (
                <li key={l.label}>
                  <Link
                    href={l.href}
                    className="text-[13px] text-white hover:text-white/70 transition-colors duration-150 no-underline"
                  >
                    {l.label}
                  </Link>
                </li>
            ...
            <div className="flex flex-wrap gap-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  href="#"
                  aria-label={s.label}
                  className="text-white hover:text-white/70 transition-colors duration-150"
                >
                  <svg
                    width="16"
                    height="16"
